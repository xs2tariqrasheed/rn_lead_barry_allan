...
import { JOB_DETAILS_SCREEN } from '../../constants/screens';
...
export default ({ jobs, loadMore, refreshing }) => {
  ...
  return (
    <>
      ...
      <Text style={styles.listHeading}>Sortera efter: Senaste</Text>
          ...
          jobs
            ...
            .map((job) => (
              <ListItem
                ...
                status={job.status}
                onPress={() =>
                  navigation.navigate(JOB_DETAILS_SCREEN, { job: job })
                }
              />
            ))}
      </ScrollView>
