        ...
        >
            <View style={styles.wraper}>
                <View style={styles.content}>
                    <Text style={styles.heading}>{'Den här zonen går inte att avaktivera just nu.'}</Text>
                    <Text style={[styles.textStyle,{marginTop:15}]}>{'Det finns ett jobb bokat inom den här zonen.'}</Text>
